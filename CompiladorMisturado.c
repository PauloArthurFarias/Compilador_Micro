...
int main()
{
    ...
    "ADD", "SUB", "MUL", "DIV", "AND", "OR", "NOT", "XOR", "SHL", "SHR", "CMP", "MOV", "GOTO", "JMP", "CALL", "RET", "JZ", "JZN"
    };
    ...
    while(fgets(line, 50, input_file))//fgets tenta ler cada linha do arquivo e armazenar no vetor temporário line, se for bem-sucedido retorna um ponteiro para line, se não retorna NULL, funcionando assim como condição para o laço
    {
        ...
        else if(strcmp(line, "AND") == 0) fprintf(output_file, "00100101\n");
        else if(strcmp(line, "OR") == 0)  fprintf(output_file, "00001101\n");
        else if(strcmp(line, "NOT") == 0) fprintf(output_file, "11110110\n"); // 11110110
        else if(strcmp(line, "XOR") == 0) fprintf(output_file, "00110101\n");
        else if(strcmp(line, "SHL") == 0) fprintf(output_file, "11010010\n");
        else if(strcmp(line, "SHR") == 0) fprintf(output_file, "11010011\n");
        else if(strcmp(line, "CMP") == 0) fprintf(output_file, "00111100\n");
        else if(strcmp(line, "MOV") == 0) fprintf(output_file, "00000001\n");
        else if(strcmp(line, "JMP") == 0) fprintf(output_file, "11101011\n");
        else if(strcmp(line, "CALL") == 0) fprintf(output_file, "11101000\n");
        else if(strcmp(line, "RET") == 0) fprintf(output_file, "11000011\n");
        else if(strcmp(line, "GOTO") == 0) fprintf(output_file, "11101011\n");
        else if(strcmp(line, "JZ") == 0) fprintf(output_file, "01110100\n");
        else if(strcmp(line, "JNZ") == 0) fprintf(output_file, "01110101\n");
